...
export default function LocationCard({ location }) {
  return (
    ...
    >
      ...
      <p className="mt-1.5 truncate text-xs text-copy-muted">{formatLabel(location.dimension)}</p>
    </Link>
  )
}
